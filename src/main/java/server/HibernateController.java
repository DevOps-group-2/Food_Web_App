...
public class HibernateController {//Should be a singleton…
    ...
    public HibernateController(String dbUrl){
        ...
        configuration.setProperty("hibernate.connection.username", System.getenv("pg"));
        configuration.setProperty("hibernate.connection.password", System.getenv("de88cff33a1d28c6"));
